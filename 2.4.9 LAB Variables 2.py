...
miles_to_kilometers = millas * 1.61
kilometers_to_miles = kilometros / 1.61

print(millas, "miles is", round(miles_to_kilometers, 2), "kilometers")
print(kilometros, "kilometers is", round(kilometers_to_miles, 2), "miles")
