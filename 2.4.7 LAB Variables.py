...
#and Adam had six apples. They were all very happy and lived for a long time. End of story
...
#various arithmetic operations on them (e.g., +, -, *, /, //, etc.). Try to print a string and 
#an integer together on one line, e.g., "Total number of apples:" and total_apples.
