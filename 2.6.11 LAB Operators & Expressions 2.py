...
min = min + dura # Total de minutos
hora = hora + min // 60 # Numero de horas
min = min % 60 # correct minutes to fall in the (0..59) range
hora = hora % 24 # correct hours to fall in the (0..23) range
print(hora, ":", min, sep='')
