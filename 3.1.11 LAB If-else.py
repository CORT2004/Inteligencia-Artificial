...
#inhabited by happy and prosperous people. The people paid taxes, 
#of course – their happiness had limits. The most important tax, 
...
#If the calculated tax was less than zero, 
#it would only mean no tax at all (the tax was equal to zero). 
...
ingresos = float(input("Ponga su ingreso anual: "))
...
print("El impuesto es:", impuesto, "thalers")
